...
class PhoneRowActions extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      anchorEl: null
  ...
  handleClose = () => {
    ...
    dispatch(editPhone( rowData.phoneType,rowData.phone));
  }
  render(){
    return (
      <div>
...
export default connect(mapStateToProps)(PhoneRowActions);
